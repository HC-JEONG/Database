...
CREATE TABLE CUSTOMER_ARTIST_INT(
      ...
      CONSTRAINT CAInt_ArtistFK FOREIGN KEY(ArtistID) REFERENCES ARTIST(ArtistID),
      CONSTRAINT CAInt_CustomerFK FOREIGN KEY(CustomerID) REFERENCES CUSTOMER(CustomerID)
      );
...
INSERT INTO CUSTOMER
      ...
      'mnF3D00Q', '10899 88th Ave', 'Bainbridge Island', 'WA', '98110', 'USA', '206', '876-9911');
...
from artistwhere substr(dateofbirth,1,2)=19;
...
select transactionid, salesprice, (sysdate-datesold)/7 WEEKS
from trans where customerid=1001;

selectmonths_betweed('01-sep-95', '11-jan-94'),
