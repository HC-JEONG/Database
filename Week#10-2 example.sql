...
SELECT transactionid, salesprice, datesold FROM trans WHERE datesold > '14/12/14';

SELECT transactionid, salesprice, datesold FROM trans WHERE datesold > TO_DATE('14/12/14','DD-MM-YY');
